...
// 검색창에 현재 useParams를 통해 받아온 keyword가 있다면 keyword로 업데이트 되게 설정
  ...
  return (
    <header className="fixed top-0 left-0 w-full m-auto flex p-4 text-xl border-zinc-600 bg-zinc-900 mb-4 z-40">
    <div className="w-full mx-8 flex">
      <button className="px-3 mr-2 hover:bg-zinc-700 rounded-full text-xl">
        {" "}
        <CiMenuBurger className=" text-white text-2xl hover:rotate-180 ease-in duration-300" />{" "}
      </button>
      ...
      <button className="px-3 hover:bg-zinc-600 rounded-full">
        {" "}
      ...
      <button className="ml-2 px-3 bg-lime-600 rounded-full">
        {" "}
